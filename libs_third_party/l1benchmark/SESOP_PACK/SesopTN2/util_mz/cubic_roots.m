function [x,nroot]=cubic_roots(a, b, c, d)
% Solve a cubic equation   a*x^3 + b*x^2 + c*x + d = 0,     where a, b, c, and d are real.
%
% Call:       [x,nroot]=cubicfcn(a, b, c, d)
%
% Input:  
%   a, b, c, d  ... coefficients (input)
%
%Output:
%   x           ... three (generally) complex solutions 
