...
% Michael Zibulevsky, 24.07.2008; 25.07.08; 27.08.08; 31.07.08; 01.07.08
%
...
FlagSesop =1;        % Optimize with:    1 - sesoptn tool;   
                                   %                                 0 - fminunc BFGS Quasi-Newton (0ptimization toolbox of MATAB)
...
else  %%%%%       Optimize using matlab optimization toolbox function fminunc:   BFGS quasi-Newton
...
addpath('../../../minFunc')
options1 =optimset('LargeScale','off','GradObj','on','Display','iter','MaxIter',4000);
