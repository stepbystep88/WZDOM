...
FlagMinFunc = 1;   %  1 - minFunc L-BFGS Quasi-Newton
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%                Learning Neural Nnet  weights via optimization:   
%
...
vcwb = nntrain_mz(Xtrain,ytrain,Xtest,ytest,par);
