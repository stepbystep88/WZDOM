...
for i=ind,
   ...
   set(h,'LineWidth',MyLineWidth); 
   k=k+1; mylegends{k}=reports(i).method;
   h=xlabel('Iteration');set(h,'FontSize',MyFontsize); 
   h=ylabel('f - fbest');set(h,'FontSize',MyFontsize); 
   hold on;
end
...
for i=ind,
   ...
   set(h,'LineWidth',MyLineWidth); 
   k=k+1; mylegends{k}=reports(i).method;
   h=xlabel('CPU Time, Sec');set(h,'FontSize',MyFontsize); 
   h=ylabel('f - fbest');set(h,'FontSize',MyFontsize); 
   hold on;
end
set(gca,'FontSize',MyFontsize); 
...
for i=ind,
   ...
   set(h,'LineWidth',MyLineWidth); hold on;
   h=xlabel('Iteration');set(h,'FontSize',MyFontsize); 
   h=ylabel('SNR, dB');set(h,'FontSize',MyFontsize); 
end
set(gca,'FontSize',MyFontsize); 
