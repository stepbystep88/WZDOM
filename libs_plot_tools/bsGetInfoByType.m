    ...
    switch lower(type)
        case 'ip'
            ...
            if strcmpi(GShowProfileParam.language, 'en')
                ...
                attName = '×è¿¹ \fontname{Times New Roman}(g/cm^3\cdotkm/s)';
            end
        ...
        case 'vp'
            ...
            if strcmpi(GShowProfileParam.language, 'en')
                ...
                attName = '×Ý²¨ËÙ¶È \fontname{Times New Roman}(km/s)';
            end
        ...
        case 'vs'
            ...
            if strcmpi(GShowProfileParam.language, 'en')
                ...
                attName = 'ºá²¨ËÙ¶È \fontname{Times New Roman}(km/s)';
            end
        ...
        case {'rho', 'density'}
            ...
            if strcmpi(GShowProfileParam.language, 'en')
                ...
                attName = 'ÃÜ¶È \fontname{Times New Roman}(g/cm^3)';
            end
