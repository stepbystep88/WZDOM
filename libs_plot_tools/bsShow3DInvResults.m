...
%             startTime = bsSmoothByGST2D(startTime, [], bsCreateGSTParam(2, 'sigma', 10, 'iterNum', 100));
            ...
            horiozons(1).shift = (sampNum - 10) * GInvParam.dt + shift * GInvParam.dt;
...
%             view_s = [121.6586   38.2342];
        case 3
            ...
            if isempty(zslices)
                zslices = 2200+sampNum/2*GInvParam.dt  + shift * GInvParam.dt;
            end
        ...
        otherwise
            ...
            horiozons(1).shift = shift * GInvParam.dt;
    end
