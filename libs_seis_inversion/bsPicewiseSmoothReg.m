...
%     fminOptions = optimoptions('fmincon', 'SpecifyObjectiveGradient',true,'SpecifyConstraintGradient',true, 'Display', 'off', ...
...
%     func = @(T) minUpdateX1(T, pkgs);
%     [params.x1, fk, exitFlag, output] = fmincon(func, params.x1, [], [], [], [], [], [], [], fminOptions);
...
%     func = @(T) minUpdateX2(T, pkgs);
%     [params.x2, ~, exitFlag, output] = fmincon(func, params.x2, [], [], [], [], [], [], [], fminOptions);
